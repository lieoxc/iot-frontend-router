  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        name: 'management_ota',
        path: '/management/ota',
        component: 'view.management_ota',
        meta: {
          title: 'management_ota',
          i18nKey: 'route.management_ota'
        }
      },
      {
        name: 'management_package',
        path: '/management/package',
        component: 'view.management_package',
        meta: {
          title: 'management_package',
          i18nKey: 'route.management_package'
        }
      },
      {
